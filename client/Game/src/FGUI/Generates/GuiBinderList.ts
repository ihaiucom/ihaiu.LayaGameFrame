...
import CommonNumberBinder from "./CommonNumber/CommonNumberBinder";
import GameGMBinder from "./GameGM/GameGMBinder";
import GameLaunchBinder from "./GameLaunch/GameLaunchBinder";
import ModuleActorGJCBinder from "./ModuleActorGJC/ModuleActorGJCBinder";
...
import ModuleStoryGJCBinder from "./ModuleStoryGJC/ModuleStoryGJCBinder";
import ModuleStoryLotteryBinder from "./ModuleStoryLottery/ModuleStoryLotteryBinder";
import ModuleStudioBinder from "./ModuleStudio/ModuleStudioBinder";
import ModuleStudioMovieClip00CommonBinder from "./ModuleStudioMovieClip00Common/ModuleStudioMovieClip00CommonBinder";
...
export default class GuiBinderList
{
	static fguiBinderAll()
	{
		...
		CommonNumberBinder.bindAll()
		GameGMBinder.bindAll()
		GameLaunchBinder.bindAll()
		ModuleActorGJCBinder.bindAll()
		...
		ModuleStoryGJCBinder.bindAll()
		ModuleStoryLotteryBinder.bindAll()
		ModuleStudioBinder.bindAll()
		ModuleStudioMovieClip00CommonBinder.bindAll()
