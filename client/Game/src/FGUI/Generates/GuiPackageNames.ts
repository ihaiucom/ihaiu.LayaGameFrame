...
export default class GuiPackageNames
{
	...
	public static CommonBase : string = "CommonBase";
	public static CommonFx : string = "CommonFx";
	public static CommonGame : string = "CommonGame";
	public static CommonNumber : string = "CommonNumber";
	public static GameGM : string = "GameGM";
	...
	public static ModuleSetting : string = "ModuleSetting";
	public static ModuleShop : string = "ModuleShop";
	public static ModuleStoryGJC : string = "ModuleStoryGJC";
	public static ModuleStoryLottery : string = "ModuleStoryLottery";
	public static ModuleStudio : string = "ModuleStudio";
	public static ModuleStudioMovieClip00Common : string = "ModuleStudioMovieClip00Common";
	public static ModuleStudioMovieClip01Normal : string = "ModuleStudioMovieClip01Normal";
	...
	public static _ResImageUI : string = "_ResImageUI";
	public static _ResImageUIV1 : string = "_ResImageUIV1";
	public static _Test : string = "_Test";
	public static __ResImageTmp : string = "__ResImageTmp";
	public static __Style : string = "__Style";
