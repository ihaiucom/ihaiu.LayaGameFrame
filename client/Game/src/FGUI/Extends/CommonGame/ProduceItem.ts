...
import ProduceItemStruct from "../../Generates/CommonGame/ProduceItemStruct";
import Game from "../../../Game";
import BuildingData from "../../../GameModule/DataStructs/BuildingData";

export default class ProduceItem extends ProduceItemStruct
{
