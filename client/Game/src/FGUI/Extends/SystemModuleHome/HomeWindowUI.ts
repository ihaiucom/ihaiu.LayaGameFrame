...
export default class HomeWindowUI extends HomeWindowUIStruct
{
    ...
    onWindowInited(): void
    {
        this.m_buildingButtonBar.visible = false;
        ...
        this.m_exitViewButton.onClick(this, this.onClickExitViewButton);
    ...
    {
        Game.home.scene.scene2D.zoomToDefault();
    }
    ...
    get tweenZoomBegin()
    {
        return Scene2D.uiTweenZoomBegin;
    }

    get tweenZoomEnd()
    {
        return Scene2D.uiTweenZoomEnd;
    }
    ...
    initTweenView()
    {
        ...
        // views2
        view = <any> this.m_exitViewButton;
        v = <any>view;
        view.layout = TweenViewLayout.Right;
        view.isHide = false;
        view.initX = v.x;
