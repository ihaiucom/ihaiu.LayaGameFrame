...
gamerMatchC2S: function(type, room){
	C2S("GamerMatchC2S", {type:type, room:room});
},
...
gamerNewRoomC2S: function(type){
	C2S("GamerNewRoomC2S", {type:type});
},
gamerNewRoomS2C: new _EventDispatch(),

gamerAddRoomC2S: function(session){
	C2S("GamerAddRoomC2S", {session:session});
},
gamerAddRoomS2C: new _EventDispatch(),

gamerLeaveRoomC2S: function(session){
	C2S("GamerLeaveRoomC2S", {session:session});
},
