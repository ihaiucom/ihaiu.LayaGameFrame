...
namespace Proto.API {
    ...
    export namespace ClientGM {
    
        export class gmTestRequest {  
        } 
    
        export class gmTestResponse {  
            num: number = 0; 
        }  
        
        export class gmUpdateOscarRequest {  
        } 
    
        export class gmUpdateOscarResponse {  
        }  
        
        export class gmPrintMemRequest {  
        } 
    
        export class gmPrintMemResponse {  
        }  
        
        export class gmTestLocalStorageSaveRequest {  
        } 
    
        export class gmTestLocalStorageSaveResponse {  
        }  
        
        export class gmTestLocalStorageReadRequest {  
        } 
    
        export class gmTestLocalStorageReadResponse {  
        }  
        
        export class gmTestTimerLoopRequest {  
        } 
    
        export class gmTestTimerLoopResponse {  
        }  
        
        export class gmTestReloginRequest {  
        } 
    
        export class gmTestReloginResponse {  
        }  
        
        export class gmTestRelogin2Request {  
        } 
    
        export class gmTestRelogin2Response {  
        }  
        
        export class gmTestPrintTotalActiveTweensRequest {  
        } 
    
        export class gmTestPrintTotalActiveTweensResponse {  
        }  
        
        export class gmTestKillAlphaTransitionRequest {  
        } 
    
        export class gmTestKillAlphaTransitionResponse {  
        }  
        
        export class gmPauseRequest {  
        } 
    
        export class gmPauseResponse {  
        }  
        
        export class gmPauseRebderRequest {  
        } 
    
        export class gmPauseRebderResponse {  
        }  
        
        export class gmCacheAsRequest {  
        } 
    
        export class gmCacheAsResponse {  
        }  
        
        export class gmStopAllTransformRequest {  
        } 
    
        export class gmStopAllTransformResponse {  
        }  
        
        export class gmEnablePrinLoopRequest {  
        } 
    
        export class gmEnablePrinLoopResponse {  
        }  
